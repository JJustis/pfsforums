        ...
        API.getPosts(token, categoryId)
            .then(async response => {
                ...
                topPosts.forEach(post => {
                    ...
                    // IMPORTANT: Use arrow function to preserve 'this' context from App.js
                    // This matches exactly how the view button is handled in app.js: 
                    ...
                    if (window.App) {
                        ...
                        viewButton.addEventListener('click', () => {
                            window.App.viewPost(viewButton.getAttribute('data-id'));
                        });
                    }
